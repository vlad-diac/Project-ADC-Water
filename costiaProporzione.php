...
{				
	if($_POST['mora'] <> "" and $_POST['recupero_crediti'] <> "")								//controllo che i campi non siano vuoti
    {		
...
<body>
  ...
  border-collapse: separate;
     text-align: center;">
      ...
      <tbody>
        <tr>
          <th style="color: white; border-bottom: 1px solid white;">Interessi di Mora</th>
          <td><input type='text' name='mora' placeholder='ES-150'/></td>
          
        </tr>
        <tr>
          <th style="color: white; border-bottom: 1px solid white;">Spese Recupero Crediti</th>
          <td><input type='text' name='recupero_crediti' placeholder='ES-150'/></td>
