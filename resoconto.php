...
<body>
    ...
    <div>
        ...
        <div style="text-align: center; margin: 0 auto; width: 900px"> <div style="text-align:center;">
            <h2 class="divider-style" style="color: rgb(255,255,255);margin-top: 20px;margin-bottom: 10px;"><span style="color: rgb(255,255,255);font-family: Bitter, serif;background-color: #292c2f;padding-left: 5px;padding-right: 5px;">Verifica i Dati Inseriti</span></h2>
            </div>
       </div>
       </div>
     ...
     text-align: center;">
      <thead>
        <tr>
          ...
          <th style="background-color: rgb(41,44,47); color:white;">NUMERO SOTTOUTENTI</th>
          <th style="background-color: rgb(41,44,47); color:white;">MC TOTALI RILEVATI</th>
          <th style="background-color: rgb(41,44,47); color:white;">MC TOTALI EROGATI</th>
          <th style="background-color: rgb(41,44,47); color:white;">IMPORTO LORDO RIPARTIZIONE</th>
        </tr>
      </thead>
      <tbody>
        <tr>
